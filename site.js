(function () {
  ...
  // Existing resource links remain intact. Only the overseas-client story has a
  // verified publication date; the remaining editorial stories stay undated until
  // WINKO supplies their actual visit or publication dates.
  const newsItems = [
    { id: "responsible-manufacturing-sustainability-2026", category: "sustainability", label: "SUSTAINABILITY", title: "Responsible Manufacturing for a More Sustainable Future", articleHeading: "Our Commitment to a More Sustainable Future", excerpt: "WINKO continues to improve material efficiency, waste management and responsible manufacturing practices as part of our commitment to long-term sustainability.", image: "index_html_files/responsible-manufacturing-2026.png", alt: "WINKO responsible manufacturing and sustainability initiative at the Jutarama factory in Malaysia", href: "news/responsible-manufacturing-sustainability-2026.html", cta: "READ STORY", featured: true, articleBody: ["At WINKO, we believe responsible manufacturing is an important part of building a more sustainable future.", "As a water storage tank manufacturer, we continue to improve our production practices with greater attention to material efficiency, waste reduction, responsible resource use and a cleaner working environment.", "Our approach includes making better use of production materials, reducing unnecessary waste and encouraging the proper recycling and management of metal off-cuts and other manufacturing materials.", "We also recognize the important role reliable water storage infrastructure plays in supporting responsible water management for buildings, industries and communities.", "Sustainability is an ongoing process. WINKO will continue reviewing our operations and identifying practical ways to improve efficiency while maintaining the quality, durability and reliability expected from our water storage solutions."], articleSignoff: "WINKO — Engineered Water Storage Solutions" },
    { id: "overseas-client-factory-visit-2026", category: "company", label: "COMPANY UPDATE", date: "2026-08-04", displayDate: "04 AUG 2026", title: "Overseas Client Factory Visit", excerpt: "Welcoming our overseas client to WINKO for a factory tour, technical discussion and closer look at our water tank manufacturing capabilities.", image: "index_html_files/overseas-client-factory-visit-blur75.png", alt: "WINKO factory visit with an overseas client reviewing water tank manufacturing facilities", href: "news/overseas-client-factory-visit-2026.html", cta: "READ STORY", featured: true },
    { id: "jkr-frp-tank-factory-visit", category: "company", label: "FACTORY VISIT", title: "JKR Visit to FRP Tank Factory", excerpt: "WINKO welcomed representatives from JKR for a factory visit focusing on FRP water tank manufacturing, production processes and product applications.", image: "assets/news/jkr-frp-tank-factory-visit-face-blur80.png", alt: "JKR representatives during an FRP water tank factory visit", href: "news/jkr-frp-tank-factory-visit.html", cta: "READ STORY", privacyBlur: true, articleHeading: "JKR Visit to FRP Tank Factory", articleBody: ["WINKO was pleased to welcome representatives from Jabatan Kerja Raya (JKR) for a visit to the FRP water tank manufacturing facility.", "The visit provided an opportunity to observe the manufacturing environment, review FRP water tank production processes and exchange technical knowledge relating to water storage solutions.", "Factory visits such as this allow closer communication between industry professionals and provide valuable opportunities to share practical manufacturing experience.", "We appreciate the representatives from JKR for taking the time to visit the facility."], articleSignoff: "WINKO — Engineered Water Storage Solutions" },
    { id: "sirim-audit-winko-stainless-steel-tank", category: "technical", label: "QUALITY ASSURANCE", title: "SIRIM Audit on WINKO Stainless Steel Tank", excerpt: "A SIRIM audit was conducted on the WINKO stainless steel water tank as part of our ongoing focus on product quality, manufacturing control and compliance.", image: "assets/news/sirim-stainless-steel-tank-audit-face-blur80.png", alt: "SIRIM audit inspection of a WINKO stainless steel sectional water tank", href: "news/sirim-audit-winko-stainless-steel-tank.html", cta: "READ STORY", privacyBlur: true, articleHeading: "SIRIM Audit on WINKO Stainless Steel Tank", articleBody: ["WINKO recently underwent a SIRIM audit involving our stainless steel water tank system.", "The audit included inspection and assessment activities relating to the product and manufacturing process as part of our ongoing commitment to quality assurance and consistent manufacturing standards.", "Our team supported the inspection process by providing access to the tank, relevant manufacturing information and the required product measurements.", "Quality control and continuous improvement remain important parts of WINKO's manufacturing operations."], articleSignoff: "WINKO — Engineered Water Storage Solutions" },
    { id: "kpkt-factory-visit", category: "company", label: "FACTORY VISIT", title: "KPKT Officers Visit WINKO Factory", excerpt: "WINKO welcomed officers from the Ministry of Housing and Local Government (KPKT) for a factory visit and discussion on our water storage solutions and manufacturing operations.", image: "assets/news/kpkt-factory-visit-face-blur80.png", alt: "KPKT officers during a factory visit and technical discussion with the WINKO team", href: "news/kpkt-factory-visit.html", cta: "READ STORY", privacyBlur: true, articleHeading: "KPKT Officers Visit WINKO Factory", articleBody: ["WINKO was pleased to welcome officers from the Ministry of Housing and Local Government, Kementerian Perumahan dan Kerajaan Tempatan (KPKT), for a factory visit.", "The visit provided an opportunity for our team to introduce WINKO's manufacturing operations, water storage solutions and production capabilities.", "The programme also included discussions and knowledge sharing between the visiting officers and the WINKO team.", "We appreciate the KPKT officers for taking the time to visit our facility and engage with our team."], articleSignoff: "WINKO — Engineered Water Storage Solutions" },
  ...
  const IMAGE_SIZES = { "index_html_files/269.png": [372, 248], "index_html_files/270.png": [374, 249], "index_html_files/668.webp": [372, 248], "index_html_files/272.png": [372, 248], "index_html_files/273.png": [372, 248], "index_html_files/880.webp": [374, 249], "index_html_files/875.webp": [372, 248], "index_html_files/hdpe-tank-reference.png": [335, 219], "index_html_files/511.webp": [373, 249], "index_html_files/963.webp": [384, 288], "index_html_files/1046.webp": [384, 288], "index_html_files/overseas-client-factory-visit-blur75.png": [1254, 1254], "index_html_files/responsible-manufacturing-2026.png": [1448, 1086], "assets/news/jkr-frp-tank-factory-visit-face-blur80.png": [1448, 1086], "assets/news/sirim-stainless-steel-tank-audit-face-blur80.png": [1448, 1086], "assets/news/kpkt-factory-visit-face-blur80.png": [1448, 1086] };
  const imageAttributes = (path) => { const dimensions = IMAGE_SIZES[path]; return dimensions ? `width="${dimensions[0]}" height="${dimensions[1]}"` : ""; };
  const PRIVACY_BLUR_NEWS_IDS = new Set(["overseas-client-factory-visit-2026", "jkr-frp-tank-factory-visit", "sirim-audit-winko-stainless-steel-tank", "kpkt-factory-visit"]);
  const needsPrivacyBlur = (item) => Boolean(item && (item.privacyBlur || PRIVACY_BLUR_NEWS_IDS.has(item.id)));
  ...
  function updateStructuredData(locale, page, pageUrl, detailTarget) {
    ...
    const articleTarget = document.querySelector("[data-news-article]");
    const article = page === "news-article" ? newsItems.find((item) => item.id === (articleTarget?.dataset.newsArticleId || "overseas-client-factory-visit-2026")) : null;
    const articleLocale = article ? translate(article.articleHeading || (article.id === "overseas-client-factory-visit-2026" ? "Overseas Client Visits WINKO Factory" : article.title), locale) : "";
    if (article) {
      const articleSchema = { "@context": "https://schema.org", "@type": "NewsArticle", headline: articleLocale, description: newsText(article, "excerpt", locale), image: [`${SITE_ORIGIN}/${article.image}`], author: { "@type": "Organization", name: "WINKO", url: `${SITE_ORIGIN}/` }, publisher: { "@type": "Organization", name: "WINKO", url: `${SITE_ORIGIN}/`, logo: { "@type": "ImageObject", url: SITE_LOGO } }, mainEntityOfPage: { "@type": "WebPage", "@id": pageUrl } };
      if (article.date) { articleSchema.datePublished = article.date; articleSchema.dateModified = article.date; }
      setJsonLd("newsArticle", articleSchema);
  ...
  function updateMetadata(locale) {
    ...
    const newsArticleId = document.querySelector("[data-news-article]")?.dataset.newsArticleId;
    const metaPage = newsArticleId === "responsible-manufacturing-sustainability-2026" ? "newsResponsible" : page;
    const articleMeta = newsArticleId && I18N.meta?.newsArticles?.[newsArticleId];
    const values = detailKey && I18N.productMeta?.[detailKey]?.[locale] ? I18N.productMeta[detailKey][locale] : (articleMeta?.[locale] || articleMeta?.en || I18N.meta?.[metaPage]?.[locale] || I18N.meta?.[metaPage]?.en || I18N.meta?.[page]?.[locale] || I18N.meta?.[page]?.en);
    ...
    if (page === "newsArticle") {
      ...
      if (articleDate) setMeta('meta[property="article:published_time"]', { property: "article:published_time" }, articleDate);
  ...
  function setupNewsHub() {
    ...
    const latest = newsItems.filter((item) => !featuredIds.has(item.id));
    ...
    const render = () => {
      ...
      const cardTemplate = (item) => `<article class="news-card" data-category="${item.category}" data-reveal><a class="news-card-media${needsPrivacyBlur(item) ? " news-media--blurred" : ""}" href="${item.href}"><img src="${item.image}" ${imageAttributes(item.image)} loading="lazy" decoding="async" alt="${newsText(item, "alt", locale)}"></a><div class="news-card-body"><span class="article-meta">${metaFor(item)}</span><h3><a href="${item.href}">${newsText(item, "title", locale)}</a></h3><p>${newsText(item, "excerpt", locale)}</p><a class="text-link news-text-link" href="${item.href}">${newsText(item, "cta", locale)}${arrowIcon()}</a></div></article>`;
      const featureTemplate = (item, index) => `<article class="news-feature" data-category="${item.category}" data-reveal><a class="news-feature-media" href="${item.href}"><img src="${item.image}" ${imageAttributes(item.image)} loading="lazy" decoding="async" alt="${newsText(item, "alt", locale)}"></a><div class="news-feature-copy"><span class="article-meta">${metaFor(item)}</span><h2 id="featured-story-title-${index}">${newsText(item, "title", locale)}</h2><p>${newsText(item, "excerpt", locale)}</p><a class="text-link news-text-link" href="${item.href}">${newsText(item, "cta", locale)}${arrowIcon()}</a></div></article>`;
  ...
  function setupNewsArticle() {
    ...
    const paragraphs = article.articleBody || [
      "We were pleased to welcome our overseas client to our factory for an on-site visit and production tour.",
    ...
    const render = () => {
      const locale = currentLanguage();
      const articleHeading = article.articleHeading || (article.id === "overseas-client-factory-visit-2026" ? "Overseas Client Visits WINKO Factory" : article.title);
      const articleMeta = `${newsText(article, "label", locale)}${article.displayDate ? ` · ${translate(article.displayDate, locale)}` : ""}`;
      target.innerHTML = `<article class="news-article" aria-labelledby="news-article-title"><section class="news-article-hero"><div class="container news-article-intro" data-reveal><p class="eyebrow">${translate("NEWS", locale)}</p><span class="article-meta">${articleMeta}</span><h1 id="news-article-title">${translate(articleHeading, locale)}</h1></div><div class="container"><figure class="news-article-media${article.id === "responsible-manufacturing-sustainability-2026" ? " news-article-media--poster" : ""}${needsPrivacyBlur(article) ? " news-media--blurred" : ""}" data-reveal><img src="${article.image}" ${imageAttributes(article.image)} loading="eager" fetchpriority="high" decoding="async" alt="${newsText(article, "alt", locale)}"></figure></div></section><section class="section news-article-content"><div class="container"><div class="news-article-body" data-reveal>${paragraphs.map((paragraph) => `<p>${translate(paragraph, locale)}</p>`).join("")}<p class="news-article-signoff">${translate(article.articleSignoff || "WINKO - Engineered Water Storage Solutions", locale)}</p><a class="text-link news-text-link news-back-link" href="news.html">${translate("BACK TO NEWS", locale)}${arrowIcon()}</a></div></div></section></article>`;
      setupReveal();
      const mediaNode = target.querySelector(".news-article-media");
      const signoffNode = target.querySelector(".news-article-signoff");
      if (mediaNode && !needsPrivacyBlur(article)) mediaNode.classList.remove("news-media--blurred");
      if (signoffNode) signoffNode.textContent = translate(article.articleSignoff || "WINKO - Engineered Water Storage Solutions", locale);
    };
    render();
    document.addEventListener("winko:languagechange", render);
  }
